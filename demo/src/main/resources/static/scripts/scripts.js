...
if (btnValidarDatos) {
  btnValidarDatos.addEventListener("click", () => {
    ...
    // Usamos el validador nativo del formulario
    const form = document.querySelector("form[th:action='@{/reserva}']");
    if (!form.checkValidity()) {
        form.reportValidity(); // Muestra los mensajes de "campo requerido"
        return; // No avanza
    }
 ...
 if (btnConfirmar) {
  btnConfirmar.addEventListener("click", (e) => {
    ...
    // El formulario se enviará automáticamente a Spring Boot.
    
    // 🚨 TODA LA LÓGICA DE LOCALSTORAGE SE ELIMINA DE AQUÍ:
    // const newRes = { ... }
